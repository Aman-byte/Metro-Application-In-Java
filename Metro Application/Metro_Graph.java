...
public class Metro_Graph {
	...
	public void display_Map() {
		ArrayList<String> keys = new ArrayList<>(vtces.keySet());
		System.out.println("\n>>>>>>>>> Interchanging Station => Destination Station <<<<<<<<<<<<<<<<<<\n");
	...
	public static void Create_Metro_Map(Metro_Graph g) {
	...
	public static void main(String[] args) throws IOException {
		Metro_Graph g = new Metro_Graph();
		Create_Metro_Map(g);

		System.out.println("\n**** WELCOME TO THE DELHI METRO *****");
		System.out.println("\nDEVELOPED BY: Aman Pratap Singh CSE-A 17\n");
		BufferedReader inp = new BufferedReader(new InputStreamReader(System.in));
		// int choice = Integer.parseInt(inp.readLine());
		// STARTING SWITCH CASE
		while (true) {
			System.out.println("\nSelect the Preference Option\n");
			System.out.println("1. STATIONS LIST IN THE MAP");
			System.out.println("2. SHOW THE METRO MAP");
			System.out.println(
					"3. GET SHORTEST DISTANCE FROM A 'SOURCE' STATION TO 'DESTINATION' STATION ALONG WITH THE COST OF TRAVEL");
			...
			switch (choice) {
				...
				case 2:
					...
					System.out.println("+-----------+-----------+");
					System.out.println("|    Y   |  Yellow Line |");
					System.out.println("|    B   |  Blue Line   |");
					System.out.println("|    O   |  Orange Line |");
					System.out.println("|    P   |  Pink Line   |");
					System.out.println("|    R   |  Red Line    |");
					System.out.println("+-----------+-----------+");
					g.display_Map();
					break;

				case 3:
					System.out.println("ENTER THE SOURCE AND DESTINATION STATIONS (Case Sensitive)\n");
					System.out.println("***PLEASE ENTER IN THE FORMAT: DDS Campus~O***");
					...
					if (!g.containsVertex(s1) || !g.containsVertex(s2) || !g.hasPath(s1, s2, processed2))
						...
						System.out.println("TOTAL DISTANCE : " + str.get(len - 1) + " KM");
						...
						System.out.print("\n\nTOTAL DISTANCE : " + str.get(len - 1) + " KM" + "\n");
						int totalCost = Integer.parseInt(str.get(len - 1)) * 5;
						System.out.println("\n\nTOTAL COST OF TRAVEL : " + totalCost + " RUPEES" + "\n");
